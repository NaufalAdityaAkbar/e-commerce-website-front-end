    ...
    <footer className="bg-gray-800 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Tentang Kami */}
          <div>
            <h3 className="text-xl font-semibold mb-4">TokoOnline</h3>
            <p className="text-gray-300 mb-4">
              Toko online terpercaya dengan berbagai produk berkualitas dan harga terjangkau.
            </p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <p className="mb-2">Email: info@tokoonline.com</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TokoOnline. Hak Cipta Dilindungi.</p>
        </div>
      </div>
    </footer>
  );
